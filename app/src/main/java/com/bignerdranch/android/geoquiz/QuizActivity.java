...
public class QuizActivity extends AppCompatActivity {
    ...
    private void updateQuestion() {
        // Log.d(TAG, "Updating text for question #" + mCurrentIndex, new Exception());
...
/*
    ...
    // I don't like seeing errors. In the forum, it said I could just delete this, but I'll keep it
    // in the comments in case it is needed later. (:
}
